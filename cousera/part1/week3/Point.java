...
public class Point implements Comparable<Point> {
    ...
    //private final Comparator<Point> comparator = new SlopeComparator();
    ...
    public static void main(String[] args) {
        /* YOUR CODE HERE */
        Point[] points = new Point[]{new Point(409, 34), new Point(478, 275), new Point(182, 469)};
        System.out.println(points[0].slopeOrder().compare(points[1], points[2]));
       // System.out.println(points[0].slopeOrder().compare(points[2], points[1]));
    }
}
